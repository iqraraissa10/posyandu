...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="shotcut icon" type="image/png" href="images/hack1.png">
	...
	<nav class="navbar navbar-inverse navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="index.php">Grafik</a>
		</div>
	  ...
	  <div class="tab-content">
	    <div role="tabpanel" class="tab-pane active" id="rangking">
			...
			<table width="100%" class="table table-striped table-bordered">
		        <thead>
		            <tr>
		                <th rowspan="2" style="vertical-align: middle" class="text-center">Nama Balita</th>
			...
			<table width="100%" id="table-akhir" class="table table-striped table-bordered">
		        <thead>
		            <tr>
		                ...
		                <th rowspan="2" style="vertical-align: middle" class="text-left">Keterangan</th>
		            </tr>
		            <tr>
		            <?php
		...
		?>
		            <tr>
						...
						?>
							...
							<?php
							$persen = $row1['hasil_alternatif'] * (10/100); 
							$persenn = $persen * 100;
							echo "<td>".round($row1['hasil_alternatif'], 2)." ( ".round($persenn, 0)."%)</td>";
							
							if ($persenn >= 48 && $persenn < 57) {
								echo "<td>Gizi Baik</td>";
							}elseif($persenn >= 57.5){
