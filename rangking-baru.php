...
?>
		<div class="row">
		  ...
		  <div class="well">
			...
			<!-- tulisan kosong bisa lu ganti, yang tulisan kosong itu yang bakal muncul di sistem -->
			    <form method="post">
				  <div class="form-group">
				    <label for="ia">Balita</label>
				    <select class="form-control" id="ia" name="ia">
				    	<option value="kosong">Pilih Nama Balita</option>
				    	<?php
						$stmt3 = $pgn1->readAll();
				  ...
				  <div class="form-group">
				    ...
				    <select class="form-control" id="ik" name="ik">
				    	<option value="kosong">Pilih Kriteria</option>
				    	<?php
						$stmt2 = $pgn2->readAll();
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" name="nn" id="nn" class="form-control">
				    <!--
